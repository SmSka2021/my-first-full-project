...
const fetchGetUserByNick = createAsyncThunk(
  'usersSlice/fetchGetUserByNick',
  async (data: string, { rejectWithValue }) => {
    try {
      const response = await userAPI.getOneUserByNick(data);
...
export default fetchGetUserByNick;
