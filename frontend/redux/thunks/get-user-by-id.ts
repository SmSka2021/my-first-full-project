...
const fetchGetOneUserById = createAsyncThunk(
  'usersSlice/fetchGetOneUserById',
  async (data: string, { rejectWithValue }) => {
    try {
      const response = await userAPI.getOneUserById(data);
...
export default fetchGetOneUserById;
